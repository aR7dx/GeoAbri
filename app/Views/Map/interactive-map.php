                    ...
                    <div class="row justify-content-center">
                        <div id="advanced-filters" class="search-container position-relative flex-column gap-3 p-4 shadow" style="display: none;">
                            ...
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">Catégories d'équipement</label>
                                <select class="form-select bg-danger" name="category" disabled>
                                    <!-- injecté en JS -->
                                </select>
                            </div>
                            ...
                            <!-- Accessibilité PMR -->
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">Accessibilité PMR + sensoriel</label>
                            ...
                            <!-- État -->
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">État</label>
                            ...
                            <!-- Activités -->
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">Activités</label>
                                <select class="form-select bg-danger" name="activites" disabled>
                                    <!-- injecté en JS -->
                                </select>
                            </div>
                            ...
                            <!-- Accès libre -->
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">Accès libre</label>
                            ...
                            <!-- Commune -->
                            <div class="d-flex flex-column">
                                <label class="form-label fw-semibold mb-1 mt-2">Commune</label>
                                <input type="text" class="form-control bg-light" name="commune" placeholder="Ex: Paris, Lyon">
                            </div>
