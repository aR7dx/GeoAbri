    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> 
        ...
        <div class="row g-3">
            <div class="col-12 col-sm-6 col-xl-3 custom-col">
                <div class="card">
                    <a href="<?= $router->generate('dashboard_equipements_management'); ?>" class="text-decoration-none text-dark">
            ...
            <div class="col-12 col-sm-6 col-xl-3 custom-col">
                <div class="card">
                    <a href="<?= $router->generate('dashboard_users_management'); ?>" class="text-decoration-none text-dark">
                        <div class="card-body d-flex gap-3 align-items-center">
            ...
            <div class="col-12 col-sm-6 col-xl-3 custom-col">
                <div class="card">
                    <a href="<?= $router->generate('dashboard_pending_management'); ?>" class="text-decoration-none text-dark">
                        <div class="card-body d-flex gap-3 align-items-center">
