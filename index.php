<?php 
$title = "Accueil - Localisation des établissements";
...
<script defer src="./src/script/leafletMap.js"></script>
<!-- ============= -->
...
<div class="card mb-5 p-3">
    <form method="GET" class="d-flex form">
        <div class="d-flex flex-column form-control border-0">
            ...
            <input name="ville" type="text" class="input-group-text" placeholder="Caen" value="<?= isset($_GET['ville']) ? htmlspecialchars($_GET['ville']) : ''; ?>"/>
        </div>
        <div class="d-flex flex-column form-control border-0">
            <label><strong>Type d'équipement</strong></label>
            <select name="type_equipement" class="form-select">
                <option value="none" <?= (isset($_GET['type_equipement']) && $_GET['type_equipement'] == 'none') ? 'selected' : ''; ?>></option>
