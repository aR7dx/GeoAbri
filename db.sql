...
DROP TABLE IF EXISTS GEO_RESERVATIONS;
...
CREATE TABLE IF NOT EXISTS GEO_RESERVATIONS
(
	id INT AUTO_INCREMENT PRIMARY KEY,
	installation_numero VARCHAR(20) NOT NULL,
...
-- Relation entre GEO_EQUIPEMENT et GEO_RESERVATION
ALTER TABLE GEO_RESERVATIONS
ADD CONSTRAINT fk_reservation_equipement
FOREIGN KEY (installation_numero)
REFERENCES GEO_EQUIPEMENT(installation_numero);

-- Relation entre GEO_UTILISATEURS et GEO_RESERVATION
ALTER TABLE GEO_RESERVATIONS
ADD CONSTRAINT fk_reservation_utilisateurs
FOREIGN KEY (user_id)
REFERENCES GEO_UTILISATEURS(user_id);
